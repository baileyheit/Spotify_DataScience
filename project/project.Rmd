...
acousticness <- ggplot(data = songs, mapping = aes(x = acousticness, y = popularity, alpha = 0.005)) +
...
energy <- ggplot(data = songs, mapping = aes(x = energy, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") +
  geom_smooth() +
...
danceability <- ggplot(data = songs, mapping = aes(x = danceability, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
duration <- ggplot(data = songs_duration, mapping = aes(x = duration_s, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
liveness <- ggplot(data = songs, mapping = aes(x = liveness, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
loudness <- ggplot(data = songs_loudness, mapping = aes(x = loudness, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
speechiness <- ggplot(data = songs, mapping = aes(x = speechiness, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
tempo <- ggplot(data = songs, mapping = aes(x = tempo, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
valence <- ggplot(data = songs, mapping = aes(x = valence, y = popularity, alpha = 0.0005)) +
  geom_point(color="dark gray") + 
  geom_smooth() +
...
The variables that have a positive relationship with popularity are: energy, danceability, and loudness. The variables that have a negative relationship with popularity are: acoustiness, instrumentalness, liveness, and speechiness. 
